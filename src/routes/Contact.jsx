...
const Contact = () => {
  ...
  return (
    <div className="contact-control-main">
      <div className="contact-control">
        <div className="container">
          <MdEmail className="cont" />
          <p>{email}</p>
          <button onClick={handleEmail} className="btn">
            {copiarEmail ? "Copiado!" : "Copiar"}
          </button>
        </div>
        <div className="container">
          <FaWhatsapp className="cont" />
          <p>{numero}</p>
          <button onClick={handleNumero} className="btn">
            {copiarNumero ? "Copiado!" : "Copiar"}
          </button>
        </div>
        <div className="container">
          <FaSquareInstagram className="cont" />
          <p>{insta}</p>
          <button onClick={handleInsta} className="btn">
            {copiarInsta ? "Copiado!" : "Copiar"}
          </button>
        </div>
      </div>
