    ...
    <div className="port-control">
      ...
      <div className="port-colum">
        <div className="card-control">
          <h2>Login com MongoDB </h2>
          <img src={login} alt="Foto do projeto" />
          <button
            className="btn-port"
            onClick={() => setShow((prev) => ({ ...prev, login: !prev.login }))}
          >
            <p>Ver mais</p>
          </button>
        ...
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() => setShow((prev) => ({ ...prev, mongo: !prev.mongo }))}
          >
            <p>Ver mais</p>
          </button>
        ...
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() => setShow((prev) => ({ ...prev, blog: !prev.blog }))}
          >
            <p>Ver mais</p>
          </button>
      ...
      <div className="port-colum">
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() =>
              setShow((prev) => ({ ...prev, chamados: !prev.chamados }))
            }
          >
            <p>Ver mais</p>
          </button>
        ...
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() =>
              setShow((prev) => ({ ...prev, cobrinha: !prev.cobrinha }))
            }
          >
            <p>Ver mais</p>
          </button>
        ...
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() =>
              setShow((prev) => ({ ...prev, Hdhost: !prev.Hdhost }))
            }
          >
            <p>Ver mais</p>
          </button>
      ...
      <div className="port-colum">
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() =>
              setShow((prev) => ({ ...prev, calculadora: !prev.calculadora }))
            }
          >
            <p>Ver mais</p>
          </button>
        ...
        <div className="card-control">
          ...
          <button
            className="btn-port"
            onClick={() =>
              setShow((prev) => ({ ...prev, qrcode: !prev.qrcode }))
            }
          >
            <p>Ver mais</p>
          </button>
