...
const Home = () => {
  const handleDownload = () => {
    ...
    link.href = "/JoaoAntunes.pdf";
    link.download = "JoaoAntunes.pdf";
  ...
  return (
    <div className="main">
      <div className="info">
        ...
        <p>
          Desenvolvedor de software apaixonador por criar sites <br></br> e
          experiências interativas na web{" "}
        </p>

        <button className="btn" onClick={handleDownload}>
          Baixar Curriculo <HiOutlineDocumentDownload />
        </button>
      </div>
