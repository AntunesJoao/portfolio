      ...
      <div className="fundo">
                  <div className="card-fundo">
                    ...
                    <div className="fundo-card-control">
                      ...
                      <div className="descrica"><h3>Tecnologias utilizadas:</h3>
                                                <ul>
                                                  <li>HTML</li>
                                                  <li>Css</li>
                                                  <li>JavaScript</li>
                                                  ...
                                                  <p>Basta escrever algo e o codigo irá gerar um QRcode vinculado
                                                    ao que foi escrito. Assim que apontar a camera, levará direto a ele.
                                                    Usei uma API para o QRcode.</p></div>
                      <div className="code">
